...
latest_transactions AS (
  SELECT DISTINCT ON (cr.data_source_id, tx.source_record_id)
    tx.id, tx.collection_run_id, tx.neighborhood_id, tx.source_record_id, tx.source_row, tx.layout, tx.area_sqm, tx.transaction_price, tx.transaction_date, tx.original_listing_ref, tx.captured_at, tx.attributes, cr.data_source_id
